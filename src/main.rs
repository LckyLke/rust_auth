...
use::std::sync::Arc;
use::warp::{Filter, reject, reply, Rejection, Reply};
...
fn init_users() -> HashMap<String, User> {
    ...
    map.insert(
        ...
        User {
            uid: String::from("1"),
            email: String::from("luke@friedrichs.com"),
    ...
    map.insert(
        ...
        User {
            uid: String::from("2"),
            email: String::from("admin@friedrichs.com"),
            password: String::from("1234"),
